...
{
    public class ProductControllerTestsForNotAdultConsumer
    {
        private readonly WebApplicationFactory<Program> factory;
        private const string baseUrl = "/api/Product/";
        private readonly IFlurlRequest request;

        public ProductControllerTestsForNotAdultConsumer()
        {
            factory = new WebApplicationFactory<Program>()
                  .WithWebHostBuilder(builder =>
                  {
                      ...
                      {
                          services.AddSingleton<IPolicyEvaluator, FakePolicyEvaluatorForNotAdultCustomer>();
                          services.AddMvc(options => options.Filters.Add(new FakeNotAdultCustomerFilter()));
                      });
                  });
        ...
        [Fact]
        public async Task GetAllProductsAsync_ForExistingProductsAndNotAdultCustomer_ReturnsForbidden()
        {
        ...
        [Fact]
        public async Task GetProductByIdAsync_ForExistingNormalProductAndNotAdultCustomer_ReturnsOk()
        {
        ...
        [Fact]
        public async Task GetProductByIdAsync_ForExistingProductForAdultsAndNotAdultCustomer_ReturnsForbidden()
        {
